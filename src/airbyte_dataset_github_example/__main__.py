"""airbyte-dataset-github-example file for ensuring the package is executable
as `airbyte-dataset-github-example` and `python -m airbyte_dataset_github_example`
"""
import importlib
